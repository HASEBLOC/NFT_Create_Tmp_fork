          ...
          params: [
            {
              ...
              rpcUrls: [
                "https://goerli.infura.io/v3/20cd5bade2c0407da65c6811cc2a1b37",
              ],
            },
          ],
        });
        ...
        <div className="bg-black pb-16 flex flex-wrap buttom justify-center">
          ...
          <div className="m-12 lg:m-32 px-12 py-6 lg:pt-8 lg:px-20 border-2 bg-black text-center border-[#FFFFFF] bg-center bg-contain bg-no-repeat">
            ...
            <div className="pt-2 lg:pt-6 pb-7">
              <button
                type="button"
                className="text-2xl lg:text-3xl inline-flex flex-shrink-0 justify-center items-center gap-2 h-[1.375rem] w-[1.375rem] lg:h-[2.375rem] lg:w-[2.375rem]
          ...
          focus:ring-[#99CDDB] focus:ring-offset-2 transition-all  rounded-full dark:focus:ring-offset-gray-800"
                onClick={mintQuantityMinus}
              >
                -
              </button>
              <a className="text-2xl lg:text-3xl px-8 lg:pt-6 lg:pb-6 text-white font-['Impact']">
                {mintQuantity}
              </a>
              <button
                type="button"
          ...
          focus:outline-none focus:ring-2 focus:ring-[#99CDDB] focus:ring-offset-2 transition-all dark:focus:ring-offset-gray-800"
                onClick={mintQuantityPlus}
              >
                +
              </button>
              <br />
            ...
            {!disabledFlag && (
              <button
                type="button"
                className="text-xl lg:text-2xl py-1 lg:py-3 px-12 lg:px-24 inline-flex justify-center items-center gap-2 rounded-full border border-transparent
